...
This repository is a **fork**: upstream [Kava-Labs/kava](https://github.com/Kava-Labs/kava)
...
a general-purpose fork of Kava-Labs/kava.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v0.28.2-ct.5`); a GitHub Release publishes the versioned images
...
terms as this repository — see [LICENSE.md](./LICENSE.md) (Apache-2.0).
