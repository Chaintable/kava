...
replace (
	...
	// Branch: official-v0.21.0-kava-v27.0 on Chaintable/ethermint
	github.com/evmos/ethermint => github.com/Chaintable/ethermint v0.0.0-20260812094936-03ae2abafcf7
